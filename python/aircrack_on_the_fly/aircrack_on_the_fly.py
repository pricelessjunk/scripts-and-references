...
MIN_LENGTH = 5
MAX_LENGTH = 6
MAX_NUMBER_OF_LINES = 1000000
PROGRESS_FILENAME = 'progress'
PASS_FILENAME = 'pass.dict'
OUTPUT_KEYS_FILENAME = 'keys.txt'
CAPTURE_FILENAME = 'capture-01.cap'
COMMAND = ['aircrack-ng','-l', OUTPUT_KEYS_FILENAME, CAPTURE_FILENAME,'-w', PASS_FILENAME]
    ...
    try:
        while cur_length <= MAX_LENGTH:
            ...
            for i in range(len(status)):
                current_lines_written *= int(status[i])
